...
Uses osascript to interact with Reminders.app via AppleScript.
...
def add_reminder(title: str, list_name: str = 'Reminders', due_date: str = None, 
                 notes: str = None, priority: int = 0) -> dict:
...
def list_reminders(list_name: str = None, include_completed: bool = False, 
...
def complete_reminder(title: str = None, reminder_id: str = None) -> dict:
...
'''
    ...
    return {
        'success': True,
        'title': result,
        'message': f'Completed reminder: {result}'
    }
...
Examples:
    ...
    add_parser.add_argument('--priority', '-p', type=int, choices=[0, 1, 2, 3], default=0,
                           help='Priority: 0=none, 1=high, 2=medium, 3=low')
