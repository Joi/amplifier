...
def main():
    ...
    if run_test("Insert simple text", "", "iHello World<ESC>", "Hello World"):
        passed += 1
    else:
        failed += 1

    if run_test("Insert with newline", "", "iLine 1<ENTER>Line 2<ESC>", "Line 1\nLine 2"):
        passed += 1
    else:
        failed += 1

    if run_test("Insert then edit", "", "iHello<ESC>aWorld<ESC>", "HelloWorld"):
        passed += 1
    else:
        failed += 1

    if run_test("Open new line below", "Line 1", "oLine 2<ESC>", "Line 1\nLine 2"):
        passed += 1
    else:
        failed += 1
    ...
    if run_test("Delete word", "hello world test", "dw", "world test"):
        passed += 1
    else:
        failed += 1

    if run_test("Delete line", "Line 1\nLine 2\nLine 3", "dd", "Line 2\nLine 3"):
        passed += 1
    else:
        failed += 1
    ...
    if run_test("Delete 2 words", "one two three four", "d2w", "three four"):
        passed += 1
    else:
        failed += 1

    if run_test("Delete multiple lines", "L1\nL2\nL3\nL4\nL5", "3dd", "L4\nL5"):
        passed += 1
    else:
        failed += 1
    ...
    if run_test("Yank line and put", "Line 1\nLine 2", "yyjp", "Line 1\nLine 2\nLine 1"):
        passed += 1
    else:
        failed += 1
    ...
    if run_test("Change word", "hello world", "cwHI<ESC>", "HI world"):
        passed += 1
    else:
        failed += 1

    if run_test("Change to end", "Hello World", "llllc$END<ESC>", "HellEND"):
        passed += 1
    else:
        failed += 1

    if run_test("Change line", "Old Line\nKeep This", "ccNew Line<ESC>", "New Line\nKeep This"):
        passed += 1
    else:
        failed += 1
    ...
    if run_test("Visual line delete", "L1\nL2\nL3", "Vd", "L2\nL3"):
        passed += 1
    else:
        failed += 1
    ...
    if run_test("Undo delete", "hello world", "dwu", "hello world"):
        passed += 1
    else:
        failed += 1

    if run_test("Undo insert", "hello", "aWORLD<ESC>u", "hello"):
        passed += 1
    else:
        failed += 1
    ...
    if run_test("Repeat delete", "one two three four", "dw.", "three four"):
        passed += 1
    else:
        failed += 1
    ...
    if run_test("Delete and recreate", "Old text here", "ddiNew text<ESC>", "New text"):
        passed += 1
    else:
        failed += 1
